      ...
      <div className="flex gap-3 sm:gap-4 overflow-x-auto pb-2 scrollbar-hide" style={{ scrollbarWidth: 'none' }}>
        {stories.map((story) => {
          ...
          return (
            ...
            >
              <div className={`relative w-14 h-14 sm:w-16 sm:h-16 rounded-full p-[3px] ${story.isOwn
              ...
              <span className={`text-[10px] sm:text-[11px] font-medium w-14 sm:w-16 text-center truncate ${story.isOwn ? 'text-gray-600 dark:text-gray-400' : 'text-gray-700 dark:text-gray-300'
                }`}>
                {story.author}
              </span>
            </button>
