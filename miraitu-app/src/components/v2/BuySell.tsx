...
const options = [
    {
        tLabel: 'buySell.machinery',
        icon: 'agriculture',
        tDescription: 'buySell.machineryDesc',
        link: '/home/machinery',
    },
    {
        tLabel: 'buySell.crops',
        icon: 'energy_savings_leaf',
        tDescription: 'buySell.cropsDesc',
        link: '/home/crops',
    },
    {
        tLabel: 'buySell.livestock',
        icon: 'pets',
        tDescription: 'buySell.livestockDesc',
        link: '/home/livestock',
    },
    {
        tLabel: 'buySell.land',
        icon: 'landscape',
        tDescription: 'buySell.landDesc',
        link: '/home/land',
    },
];
        ...
        <section className="px-4 md:px-6 pt-4 pb-8">
            <div className="mx-auto max-w-[1400px]">
                ...
                <div className="mb-5">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{t('homeV2.buySellSubtitle')}</p>
                </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-5">
                    {options.map((opt) => (
                        ...
                        >
                            ...
                            <h3 className="text-sm md:text-lg font-black mb-1 text-gray-900 dark:text-white group-hover:text-primary transition-colors">{t(opt.tLabel)}</h3>
                            <p className="text-[11px] md:text-sm text-gray-500 dark:text-gray-400 leading-snug">{t(opt.tDescription)}</p>
                        </Link>
                    ))}
                </div>
            </div>
