                ...
                <div className="mx-auto max-w-[1400px] px-4 py-3 overflow-visible">
                    ...
                    <div className="flex items-center justify-between gap-2 sm:gap-4">
                        ...
                        <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
                            {/* The Play Store and App Store buttons that stood here
                                are gone: neither linked to a store listing — both
                                pointed back at /home/about — so they promised a
                                download the site cannot deliver. */}
                            <button
