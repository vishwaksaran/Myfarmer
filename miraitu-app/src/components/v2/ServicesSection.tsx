            ...
            <div className="mx-auto max-w-[1400px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                    ...
                    <div className="md:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {/* Tractor Mechanics */}
                        <div className="skeuo-card-hover group flex flex-col p-6 rounded-3xl relative overflow-hidden">
                            ...
                            <div className="mb-auto">
                                <div className="flex items-center justify-between mb-5">
                                    <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-orange-100 to-amber-50 flex items-center justify-center group-hover:scale-110 transition-transform">
                                        <span className="material-symbols-outlined text-orange-600 text-xl">engineering</span>
                                    </div>
                                    <div className="flex items-center gap-1.5 bg-green-50 rounded-full px-3 py-1">
                                        <div className="h-2 w-2 rounded-full bg-green-500 animate-pulse"></div>
                                        <span className="text-[10px] font-bold text-green-600">{t('services.availableNow')}</span>
                                    </div>
                                </div>
                                <h4 className="text-lg font-black mb-2 group-hover:text-primary transition-colors">{t('services.tractorMechanics')}</h4>
                        ...
                        <div className="skeuo-card-hover group flex flex-col p-6 rounded-3xl relative overflow-hidden">
                            ...
                            <div className="mb-auto">
                                <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-blue-100 to-cyan-50 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
                                    <span className="material-symbols-outlined text-blue-600 text-xl">ac_unit</span>
                                </div>
                                <h4 className="text-lg font-black mb-2 group-hover:text-primary transition-colors">{t('services.coldStorage')}</h4>
                                <p className="text-sm text-gray-500 leading-relaxed">
                                    {t('services.coldStorageDesc')}
                                </p>
                                <div className="mt-4 skeuo-inset rounded-xl p-3">
