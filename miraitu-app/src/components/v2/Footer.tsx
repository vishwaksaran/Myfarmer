...
export default function Footer() {
    ...
    return (
        <footer className="bg-gradient-to-b from-[#1a3617] to-[#0d1f0b] text-white relative overflow-hidden">
            ...
            <div className="hidden md:block mx-auto max-w-[1400px] px-6 py-14 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                    ...
                    <div>
                        ...
                        {/* The "Download the App" block and its two store buttons
                            are gone — see the note in Header.tsx. */}
                    </div>
            ...
            {/* ───────────────────────── Mobile-only rich ending ───────────────────────── */}
            <div className="md:hidden relative z-10 px-6 pt-10 pb-8 text-center overflow-hidden">
                {/* Animated seedling emoji */}
                <div className="text-5xl mb-3 animate-bounce" style={{ animationDuration: '2.5s' }}>🌾</div>

                {/* Heading */}
                <h3 className="text-xl font-black text-white leading-tight">{t('footer.endTitle')}</h3>
                <p className="text-sm text-gray-300/70 mt-1.5">{t('footer.endSub')}</p>
                ...
                <div className="flex justify-center gap-2.5 mt-6">
                    {[
                        ...
                        <a key={i} href={social.link} target="_blank" rel="noopener noreferrer" aria-label={social.label} className={`size-10 rounded-xl bg-white/10 ${social.hover} flex items-center justify-center transition-all active:scale-90`}>
                            {social.svg}
                        </a>
                    ))}
                </div>
                ...
                {/* Helpline pill */}
                <a href="tel:+919380306475" className="inline-flex items-center gap-2 mt-6 rounded-full bg-accent/15 border border-accent/20 px-4 py-2">
                    <span className="material-symbols-outlined text-accent text-lg">call</span>
                    <span className="text-sm font-bold text-accent">+91 93803 06475</span>
                </a>
                ...
                <button
                    ...
                    className="inline-flex items-center gap-1.5 mt-6 rounded-full bg-white/10 hover:bg-white/15 px-4 py-2 text-xs font-bold text-white transition-colors active:scale-95"
                >
                ...
                <h2 className="select-none pointer-events-none mt-8 -mb-3 text-[22vw] leading-none font-black tracking-tighter text-white/5">Miraitu</h2>
            </div>
