...
const popularBrands = [
    { name: 'Mahindra', slug: 'mahindra', logo: '/images/brands/tractors/mahindra-real.jpg', color: '#e41e26' },
    { name: 'John Deere', slug: 'john-deere', logo: '/images/brands/tractors/john-deere-real.png', color: '#367c2b' },
    { name: 'Sonalika', slug: 'sonalika', logo: '/images/brands/tractors/sonalika-real.png', color: '#00529b' },
    { name: 'Swaraj', slug: 'swaraj', logo: '/images/brands/tractors/swaraj-real.png', color: '#c60c30' },
    { name: 'Kubota', slug: 'kubota', logo: '/images/brands/tractors/kubota-real.jpg', color: '#f47920' },
    { name: 'Eicher', slug: 'eicher', logo: '/images/brands/tractors/eicher-real.png', color: '#003d79' },
    { name: 'New Holland', slug: 'new-holland', logo: '/images/brands/tractors/new-holland-real.png', color: '#0033a0' },
    { name: 'Massey Ferguson', slug: 'massey-ferguson', logo: '/images/brands/tractors/massey-ferguson-real.png', color: '#c8102e' },
    { name: 'Farmtrac', slug: 'farmtrac', logo: '/images/brands/tractors/farmtrac-real.png', color: '#e31e24' },
    { name: 'Powertrac', slug: 'powertrac', logo: '/images/brands/tractors/powertrac-real.jpg', color: '#d80027' },
];
