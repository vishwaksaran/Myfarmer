            ...
            <section className="relative px-6 py-12 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20">
                <div className="mx-auto max-w-[1280px]">
                    ...
                    <div className="text-center mb-12 pt-10">
                        <div className="inline-flex items-center justify-center size-20 rounded-[2rem] bg-gradient-to-br from-green-600 to-emerald-600 text-white mb-6 shadow-2xl">
                            ...
                            <div className="space-y-4">
                                ...
                                {formData.area_size && (
                                    <div className="mt-6 p-6 rounded-2xl bg-green-50 dark:bg-green-900/20 border-2 border-green-100 dark:border-green-800">
                                        ...
                                        <p className="text-4xl font-black text-green-600 dark:text-green-400">₹{calculateCost()}</p>
