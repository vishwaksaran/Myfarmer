                        ...
                        {teamMembers.map((member) => (
                            ...
                            >
                                ...
                                <div className="relative h-[320px] md:h-[420px] overflow-hidden bg-gradient-to-b from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900">
                                    ...
                                    {/* LinkedIn Badge — always visible on mobile, hover/focus on sm+ */}
                                    <div className="absolute top-5 right-5 w-12 h-12 bg-[#0A66C2] sm:bg-white/30 backdrop-blur-md rounded-xl flex items-center justify-center border border-[#0A66C2] sm:border-white/40 shadow-lg opacity-100 sm:opacity-0 sm:group-hover:opacity-100 sm:group-focus-visible:opacity-100 sm:group-hover:bg-[#0A66C2] sm:group-hover:border-[#0A66C2] sm:group-hover:scale-110 transition-all duration-300 pointer-events-auto sm:pointer-events-none sm:group-hover:pointer-events-auto sm:group-focus-visible:pointer-events-auto">
                ...
                <div className="mx-auto max-w-[1280px]">
                    <div className="rounded-2xl md:rounded-[2.5rem] bg-gradient-to-r from-[#1a3a14] to-[#2d5a24] p-6 md:p-12 lg:p-16 text-center text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            {/* The Play Store and App Store buttons that closed this
                                section are gone — both were href="#", so they did
                                nothing at all. See the note in Header.tsx. */}
                        </div>
                    </div>
                </div>
            </section>
