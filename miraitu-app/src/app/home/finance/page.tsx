...
const services = [
    { nameKey: 'financePage.loan', descEn: 'Get agricultural loans for equipment, crops, and land development', icon: 'account_balance', href: '/home/finance/loan', badge: '', badgeColor: '' },
    { nameKey: 'financePage.insurance', descEn: 'Protect your crops, livestock, and equipment with comprehensive coverage', icon: 'verified_user', href: '/home/finance/insurance', badge: '', badgeColor: '' },
];

const stats = [
    { labelEn: 'Partner Banks', value: '25+', icon: 'account_balance' },
    { labelEn: 'Loans Disbursed', value: '₹50Cr+', icon: 'payments' },
    { labelEn: 'Claims Settled', value: '98%', icon: 'check_circle' },
    { labelEn: 'Processing Time', value: '48 hrs', icon: 'schedule' },
];

const benefits = [
    { titleEn: 'Low Interest Rates', descEn: 'Competitive rates starting from 4% p.a. for agricultural loans', icon: 'trending_down' },
    { titleEn: 'Quick Approval', descEn: 'Get loan approval within 48 hours with minimal documentation', icon: 'bolt' },
    { titleEn: 'Flexible Repayment', descEn: 'Pay after harvest with seasonal repayment options', icon: 'event_repeat' },
    { titleEn: 'Digital Process', descEn: '100% paperless application and disbursal process', icon: 'phone_android' },
];
        ...
        <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background-light dark:bg-background-dark text-[#121811] dark:text-[#f9fbf9] transition-colors duration-300">
            <div className="px-6 py-8">
                <div className="mx-auto max-w-[1280px]">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
                        {stats.map((stat) => (
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-500">{tp(stat.labelEn)}</p>
                            </div>
                        ))}
                    </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {services.map((service) => (
                                ...
                                >
                                    ...
                                    <p className="text-gray-500 mb-4">{tp(service.descEn)}</p>
                    ...
                    {/* Benefits Section */}
                    <div className="mb-10">
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">{tp('Why Choose Miraitu Finance?')}</h2>
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                            {benefits.map((benefit) => (
                                ...
                                >
                                    ...
                                    <h3 className="font-bold text-gray-900 dark:text-white mb-2">{tp(benefit.titleEn)}</h3>
                                    <p className="text-sm text-gray-500">{tp(benefit.descEn)}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/90">{tp('Access PM-KISAN, KCC, and other subsidized loans and insurance schemes')}</p>
                                </div>
                            </div>
                            <a
                    ...
                    <div className="bg-gradient-to-r from-primary to-emerald-500 rounded-3xl p-8 text-white">
                        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                            <div>
                                ...
                                <p className="text-white/90">{tp('Talk to our experts who understand agricultural financing.')}</p>
                            </div>
                            <a
