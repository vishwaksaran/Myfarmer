...
export const categoryProducts: Record<string, Product[]> = {
    ...
    'solar-dry-products': [
        // ── RaloS Brand – 19 Products (15% Flat Off) ────────────────────────
        { id: 801, name: 'Moringa Powder', price: '₹187', originalPrice: '₹220', rating: 4.8, reviews: 312, image: 'https://images.unsplash.com/photo-1556909172-54557c7e4fb7?w=400&h=400&fit=crop', badge: 'Popular', description: '100% Natural, No added Chemicals & Preservatives • 100 gms' },
        { id: 802, name: 'Banana Powder', price: '₹183', originalPrice: '₹215', rating: 4.6, reviews: 198, image: 'https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=400&h=400&fit=crop', badge: null, description: '100% Natural, No added Chemicals & Preservatives • 100 gms' },
        { id: 803, name: 'Baby Food – Tinny Tunny Foods', price: '₹187', originalPrice: '₹220', rating: 4.7, reviews: 145, image: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400&h=400&fit=crop', badge: 'New', description: '100% Natural, No added Chemicals & Preservatives • 100 gms' },
        { id: 804, name: 'Curry Leaf Powder', price: '₹128', originalPrice: '₹150', rating: 4.9, reviews: 423, image: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=400&h=400&fit=crop', badge: 'Best Seller', description: '100% Natural, No added Chemicals & Preservatives • 100 gms' },
        { id: 805, name: 'Amla Powder', price: '₹187', originalPrice: '₹220', rating: 4.8, reviews: 356, image: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400&h=400&fit=crop', badge: 'Top Rated', description: '100% Natural, No added Chemicals & Preservatives • 100 gms' },
        { id: 806, name: 'Beet Root Powder', price: '₹183', originalPrice: '₹215', rating: 4.7, reviews: 267, image: 'https://images.unsplash.com/photo-1601004890684-d8cbf643f5f2?w=400&h=400&fit=crop', badge: null, description: '100% Natural, No added Chemicals & Preservatives • 100 gms' },
        { id: 807, name: 'Aloe Vera Powder', price: '₹221', originalPrice: '₹260', rating: 4.6, reviews: 189, image: 'https://images.unsplash.com/photo-1596178065887-1198b6148b2b?w=400&h=400&fit=crop', badge: null, description: '100% Natural, No added Chemicals & Preservatives • 100 gms' },
        { id: 808, name: 'Hibiscus Powder', price: '₹202', originalPrice: '₹238', rating: 4.7, reviews: 234, image: 'https://images.unsplash.com/photo-1596178065887-1198b6148b2b?w=400&h=400&fit=crop', badge: 'Popular', description: '100% Natural, No added Chemicals & Preservatives • 100 gms' },
        { id: 809, name: 'Wheat Grass Powder', price: '₹204', originalPrice: '₹240', rating: 4.8, reviews: 178, image: 'https://images.unsplash.com/photo-1556909172-54557c7e4fb7?w=400&h=400&fit=crop', badge: null, description: '100% Natural, No added Chemicals & Preservatives • 100 gms' },
        { id: 810, name: 'ABC Powder (Apple Beetroot Carrot)', price: '₹242', originalPrice: '₹285', rating: 4.7, reviews: 298, image: 'https://images.unsplash.com/photo-1590779033100-9f60a05a013d?w=400&h=400&fit=crop', badge: 'Detox', description: 'Supports natural detox & digestion for healthy skin glow • 100 gms (50 gms @ ₹140)' },
        { id: 811, name: 'Multhai Mutti Powder', price: '₹94', originalPrice: '₹110', rating: 4.5, reviews: 134, image: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=400&h=400&fit=crop', badge: null, description: '100% Natural herbal powder • 100 gms' },
        { id: 812, name: 'Idli Podi / Rice Mix', price: '₹128', originalPrice: '₹150', rating: 4.8, reviews: 389, image: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400&h=400&fit=crop', badge: 'Popular', description: 'Made of Natural spices to enrich the Idli or Rice Mix • 100 gms' },
        { id: 813, name: 'Detox Juice – Amla Beetroot', price: '₹200', originalPrice: '₹235', rating: 4.6, reviews: 212, image: 'https://images.unsplash.com/photo-1601004890684-d8cbf643f5f2?w=400&h=400&fit=crop', badge: 'Detox', description: 'Helps reduce digestion issues & supports free motion • 100 gms' },
        { id: 814, name: 'Herbal Tea – Vedic Kada', price: '₹213', originalPrice: '₹250', rating: 4.9, reviews: 445, image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?w=400&h=400&fit=crop', badge: 'Top Rated', description: 'Ashwagandha, Yashtimadhu & Shatavari – natural herbal blend to boost immunity daily • 100 gms' },
        { id: 815, name: 'KayaShuddi – Body Scrub', price: '₹157', originalPrice: '₹185', rating: 4.7, reviews: 167, image: 'https://images.unsplash.com/photo-1556909172-54557c7e4fb7?w=400&h=400&fit=crop', badge: null, description: 'Vedic blend of Ashwagandha, Yashtimadhu & Shatavari for daily strength & balance • 100 gms' },
        { id: 816, name: 'Herbal Hair Pack', price: '₹166', originalPrice: '₹195', rating: 4.8, reviews: 298, image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=400&fit=crop', badge: 'Best Seller', description: 'Henna, Amla, Shikakai, Bhringraj & 15+ Ayurvedic herbs for naturally strong, shiny hair • 100 gms' },
        { id: 817, name: 'Multi Purpose Balm', price: '₹55', originalPrice: '₹65', rating: 4.6, reviews: 189, image: 'https://images.unsplash.com/photo-1556909172-54557c7e4fb7?w=400&h=400&fit=crop', badge: null, description: 'Multi-Purpose Herbal Balm for All Ages – Made with Pure Ghee & Honey Wax • 100 gms' },
        { id: 818, name: 'Tulasmrit Drops', price: '₹94', originalPrice: '₹110', rating: 4.7, reviews: 224, image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?w=400&h=400&fit=crop', badge: null, description: 'Soothes throat, supports relief from cold & cough, promotes respiratory comfort • 100 gms' },
        { id: 819, name: 'Moringa Podi', price: '₹128', originalPrice: '₹150', rating: 4.8, reviews: 267, image: 'https://images.unsplash.com/photo-1556909172-54557c7e4fb7?w=400&h=400&fit=crop', badge: null, description: 'Made of Natural spices to enrich the Idli or Rice Mix • 100 gms' },
    ],
    'organic-manure': [
