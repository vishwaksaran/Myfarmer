                ...
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50" onClick={() => setShowSuccessModal(false)}>
                    <div className="bg-white dark:bg-[#1a231a] rounded-2xl md:rounded-3xl p-6 md:p-10 shadow-2xl max-w-sm w-full" onClick={e => e.stopPropagation()} style={{ animation: 'successPop 0.5s ease-out' }}>
                        <div className="text-center">
                            ...
                            <h2 className="text-2xl md:text-3xl font-black text-gray-900 dark:text-white mb-2 md:mb-3">Land Listing Submitted!</h2>
                            <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 font-bold mb-1">Great job! 🚀</p>
                            <p className="text-sm md:text-base text-gray-500 dark:text-gray-400 mb-4">Your land listing has been submitted successfully. Our team will review it and contact you soon with verified buyer matches.</p>
                            <div className="bg-green-50 dark:bg-green-900/20 rounded-xl px-4 py-3 mb-4">
                                <p className="text-sm font-bold text-green-700 dark:text-green-400">📞 Our team will contact you shortly</p>
                            </div>
