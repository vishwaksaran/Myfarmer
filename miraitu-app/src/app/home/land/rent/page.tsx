                            ...
                            <div className="space-y-4 md:space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="title" value={formData.title} onChange={handleChange} placeholder="e.g. 5 Acres Irrigated Field" className="w-full px-3 md:px-4 py-2 md:py-3 rounded-lg md:rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-sm md:text-base" />
                                    </div>
                                    <div>
                                        <label className="block text-xs md:text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Location</label>
                                        <input type="text" name="location" value={formData.location} onChange={handleChange} placeholder="e.g. Mandya, Karnataka" className="w-full px-3 md:px-4 py-2 md:py-3 rounded-lg md:rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-sm md:text-base" />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="rentPrice" value={formData.rentPrice} onChange={handleChange} placeholder="e.g. ₹15,000/acre/season" className="w-full px-3 md:px-4 py-2 md:py-3 rounded-lg md:rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-sm md:text-base" />
                                    </div>
                                    <div>
                                        <label className="block text-xs md:text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Rental Period</label>
                                        <select name="period" value={formData.period} onChange={handleChange} className="w-full px-3 md:px-4 py-2 md:py-3 rounded-lg md:rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-sm md:text-base">
                    ...
                    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50">
                        <div className="bg-white dark:bg-[#1a231a] rounded-2xl md:rounded-3xl p-6 md:p-10 shadow-2xl max-w-sm w-full animate-bounce">
                            <div className="text-center">
                                ...
                                <h2 className="text-2xl md:text-3xl font-black text-gray-900 dark:text-white mb-2 md:mb-3">Listing Created!</h2>
                                <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 font-bold mb-1">Awesome! 🎉</p>
                                <p className="text-sm md:text-base text-gray-500 dark:text-gray-400 mb-6 md:mb-8">The Miraitu team will contact you soon with interested farmers.</p>
                                <div className="flex items-center justify-center gap-3 text-primary font-bold text-sm md:text-base">
                                    <span className="material-symbols-outlined text-xl animate-pulse">favorite</span>
