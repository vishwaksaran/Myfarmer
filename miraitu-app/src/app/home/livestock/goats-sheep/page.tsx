...
const listings = [
    { id: 1, name: 'Osmanabadi Goat Pair', breed: 'Osmanabadi', count: 2, price: '₹25,000', location: 'Osmanabad, Maharashtra', image: 'https://images.unsplash.com/photo-1524024973431-2ad916746881?w=400&h=300&fit=crop', verified: true, seller: 'Vijay Jadhav', phone: '+91 76543 21098' },
    { id: 2, name: 'Jamunapari Female', breed: 'Jamunapari', count: 1, price: '₹18,000', location: 'Mathura, UP', image: 'https://images.unsplash.com/photo-1533318087102-b3ad366ed041?w=400&h=300&fit=crop', verified: true, seller: 'Ram Prasad', phone: '+91 65432 10987' },
    { id: 3, name: 'Sirohi Buck', breed: 'Sirohi', count: 1, price: '₹22,000', location: 'Sirohi, Rajasthan', image: 'https://images.unsplash.com/photo-1524024973431-2ad916746881?w=400&h=300&fit=crop', verified: false, seller: 'Bheru Lal', phone: '+91 54321 09876' },
    { id: 4, name: 'Corriedale Sheep Flock', breed: 'Corriedale', count: 10, price: '₹75,000', location: 'Shimla, HP', image: 'https://images.unsplash.com/photo-1484557985045-edf25e08da73?w=400&h=300&fit=crop', verified: true, seller: 'Prem Singh', phone: '+91 43210 98765' },
    { id: 5, name: 'Boer Cross Kids', breed: 'Boer', count: 4, price: '₹32,000', location: 'Pune, Maharashtra', image: 'https://images.unsplash.com/photo-1533318087102-b3ad366ed041?w=400&h=300&fit=crop', verified: false, seller: 'Sanjay More', phone: '+91 32109 87654' },
    { id: 6, name: 'Black Bengal Goats', breed: 'Black Bengal', count: 5, price: '₹45,000', location: 'Kolkata, WB', image: 'https://images.unsplash.com/photo-1524024973431-2ad916746881?w=400&h=300&fit=crop', verified: true, seller: 'Amit Biswas', phone: '+91 21098 76543' },
];
