...
const listings = [
    { id: 1, name: 'Country Chicken - 50 Birds', type: 'Country Chicken', count: 50, price: '₹15,000', location: 'Coimbatore, TN', image: 'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?w=400&h=300&fit=crop', verified: true, seller: 'Karthik Raja', phone: '+91 87654 32109' },
    { id: 2, name: 'Layer Hens - 100 Birds', type: 'Layer', count: 100, price: '₹35,000', location: 'Namakkal, TN', image: 'https://images.unsplash.com/photo-1612170153139-6f881ff067e0?w=400&h=300&fit=crop', verified: true, seller: 'Saravanan S', phone: '+91 76543 21098' },
    { id: 3, name: 'Kadaknath Pair', type: 'Kadaknath', count: 2, price: '₹3,500', location: 'Jhabua, MP', image: 'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?w=400&h=300&fit=crop', verified: false, seller: 'Mohan Lal', phone: '+91 65432 10987' },
    { id: 4, name: 'Broiler Chicks - 500', type: 'Broiler', count: 500, price: '₹17,500', location: 'Pune, Maharashtra', image: 'https://images.unsplash.com/photo-1569396116180-210c182bedb8?w=400&h=300&fit=crop', verified: true, seller: 'Rajesh Kumar', phone: '+91 54321 09876' },
    { id: 5, name: 'Ducks - 20 Birds', type: 'Duck', count: 20, price: '₹8,000', location: 'Alappuzha, Kerala', image: 'https://images.unsplash.com/photo-1459682687441-7761439a709d?w=400&h=300&fit=crop', verified: false, seller: 'Thomas George', phone: '+91 43210 98765' },
    { id: 6, name: 'Turkey Pair', type: 'Turkey', count: 2, price: '₹6,000', location: 'Bangalore, Karnataka', image: 'https://images.unsplash.com/photo-1574672280600-4accfa5b6f98?w=400&h=300&fit=crop', verified: true, seller: 'Venkatesh R', phone: '+91 32109 87654' },
];
