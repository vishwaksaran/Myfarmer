...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://www.miraitu.in/home/community',
    },
    robots: {
        index: true,
        follow: true,
    ...
    openGraph: {
        ...
        url: 'https://www.miraitu.in/home/community',
        type: 'website',
        siteName: 'Miraitu',
    },
    twitter: {
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        itemListElement: [
                            ...
                            { '@type': 'ListItem', position: 2, name: 'Community', item: 'https://www.miraitu.in/home/community' },
                        ],
                    }),
                }}
            />
