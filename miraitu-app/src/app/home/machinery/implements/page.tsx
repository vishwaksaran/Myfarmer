            ...
            <div className="mx-auto max-w-[1280px]">
                <div className="mb-6 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Implements Marketplace</h1>
                            <p className="text-sm text-gray-500">Ploughs, rotavators, harrows & more</p>
                        </div>
                    </div>
                ...
                <div className="min-h-[500px]">
                    ...
                    {activeTab === 'rent' && (
                        <div className="animate-fadeIn flex flex-col items-center justify-center py-12 text-center">
                            ...
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Rent Implements</h2>
                            <p className="text-gray-500 mb-6 max-w-sm">Hire ploughs, rotavators, disc harrows, seed drills and more by the hour, day, or season.</p>
