    ...
    return (
        <div className="px-3 sm:px-6">
            <div className="mx-auto max-w-[1280px]">
                ...
                <div className="mb-8">
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-2">{tp('Buy Used Implements')}</h1>
                    <p className="text-gray-500">{tp('Browse verified pre-owned farming implements from trusted sellers.')}</p>
                </div>
