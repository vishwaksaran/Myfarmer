...
export default function StoragePage() {
    ...
    return (
        <div className="min-h-screen bg-background-light dark:bg-background-dark">
            {/* Hero Section */}
            <section className="relative px-6 py-12 bg-gradient-to-br from-slate-50 to-gray-50 dark:from-slate-900/20 dark:to-gray-900/20">
                <div className="mx-auto max-w-[1280px]">
                    ...
                    <div className="text-center mb-12 pt-10">
                        <div className="inline-flex items-center justify-center size-20 rounded-[2rem] bg-gradient-to-br from-slate-700 to-gray-800 text-white mb-6 shadow-2xl">
                        ...
                        {storageServices.map((service, index) => (
                            <div key={index} className="skeuo-card rounded-3xl p-8 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                                <div className="flex items-start gap-6">
                                    <div className="size-16 rounded-2xl flex items-center justify-center flex-shrink-0 bg-slate-100 dark:bg-slate-800">
                                        <span className="material-symbols-outlined text-3xl text-slate-600 dark:text-slate-400">{service.icon}</span>
                                    </div>
                                    <div className="flex-1">
                                        <div className="flex items-start justify-between mb-4">
                                            <h3 className="text-2xl font-black text-gray-900 dark:text-white">{service.title}</h3>
                                            <span className="text-lg font-bold text-slate-600 dark:text-slate-400">{service.price}</span>
                                        </div>
                                        ...
                                        <button className="w-full rounded-xl py-3 bg-slate-700 hover:bg-slate-800 text-white font-bold transition-colors">
                                            Book Space
                                        </button>
                                    </div>
                                </div>
            ...
            {/* Booking Form */}
            <section className="px-6 py-12 bg-slate-50/50 dark:bg-slate-900/10">
                <div className="mx-auto max-w-[1280px]">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        {/* Cost Calculator */}
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-xl px-4 py-3 bg-gray-50 dark:bg-gray-700 border-2 border-transparent focus:border-slate-500 outline-none transition-colors dark:text-white"
                                ...
                                {formData.quantity && formData.duration && (
                                    <div className="mt-6 p-6 rounded-2xl bg-slate-50 dark:bg-slate-900/20 border-2 border-slate-100 dark:border-slate-800">
                                        <p className="text-sm font-bold text-gray-600 dark:text-gray-400 mb-2">Estimated Storage Cost</p>
                                        <p className="text-4xl font-black text-slate-700 dark:text-slate-300">₹{calculateCost()}</p>
                        ...
                        <div className="skeuo-card rounded-3xl p-8 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                            ...
                            <div className="space-y-4">
                                ...
                                <button className="w-full rounded-xl py-4 bg-gradient-to-r from-slate-700 to-gray-800 text-white font-black text-lg shadow-lg hover:shadow-slate-500/30 active:scale-[0.98] transition-all mt-6">
                                    FIND GODOWN
                                </button>
                            </div>
                        </div>
