                    ...
                    <div className="mx-auto max-w-lg px-6 text-center">
                        <div className="bg-white dark:bg-gray-900 rounded-[2rem] p-10 shadow-xl border border-gray-100 dark:border-gray-800">
                            ...
                            <div className="flex gap-3">
                                <Link href="/v2/shop" className="flex-1 py-3 rounded-xl bg-primary text-white font-bold text-center hover:brightness-110 transition-all">
                                    Continue Shopping
                                </Link>
                                <Link href="/v2" className="flex-1 py-3 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-bold text-center hover:bg-gray-200 dark:hover:bg-gray-700 transition-all">
                                    Go Home
                                </Link>
                            </div>
                        </div>
            ...
            <main className="py-8">
                <div className="mx-auto max-w-[1100px] px-6">
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
                        <Link href="/v2/shop" className="hover:text-primary transition-colors">Shop</Link>
